...
- все остальные еженедельно сдают коллоквиум до тех пор, пока не сдадут на балл выше "проходного для проекта". По результатам сдачи коллоквиума получают индивидуальный проект, меньшего размера, который также будет оценен в 100 баллов максимум по результатам сдачи

- каждый проект по результатам работы будет оценен максимумом в 100 баллов, каждый участник проекта получит эту оценку в свой табель
